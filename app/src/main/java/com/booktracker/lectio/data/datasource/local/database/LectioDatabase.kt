...
import com.booktracker.lectio.data.datasource.local.dao.ReviewDao
...
@Database(
    entities = [BookEntity::class, GenreEntity::class, BookGenreCrossRef::class, ReviewEntity::class],
    version = 1,
    exportSchema = false
)
